...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\GlobalSecureAccess.ps\functions", "$global:testroot\..\GlobalSecureAccess.ps\internal\functions"),
	
	[string]
	$ModuleName = "GlobalSecureAccess.ps",
...
$CommandPath = @(
    "$global:testroot\..\GlobalSecureAccess.ps\functions"
    "$global:testroot\..\GlobalSecureAccess.ps\internal\functions"
)
