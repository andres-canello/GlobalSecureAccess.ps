...
Remove-Module GlobalSecureAccess.ps -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\GlobalSecureAccess.ps\GlobalSecureAccess.ps.psd1"
Import-Module "$PSScriptRoot\..\GlobalSecureAccess.ps\GlobalSecureAccess.ps.psm1" -Force
